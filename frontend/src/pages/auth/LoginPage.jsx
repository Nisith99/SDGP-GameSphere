    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">
          Sign in to GameSphere
        </h2>
        <p className="mt-2 text-center text-sm text-gray-600">
          Your ultimate destination for sports gaming and stats
        </p>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow-lg sm:rounded-lg sm:px-10 border border-gray-200">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <Link to="/" className="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                <svg
                  className="w-5 h-5 mr-2"
                  fill="currentColor"
                  viewBox="0 0 20 20"
          ...
          <div className="mt-6 border-t border-gray-200 pt-6">
            <div className="flex items-center justify-center">
              <div className="text-sm">
                <span className="text-gray-500">New to GameSphere?</span>
                <Link
                  to="/signup"
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-2xl px-4">
        <div className="flex justify-center space-x-6">
          ...
          <div className="text-center">
            ...
            <p className="mt-2 text-sm font-medium text-gray-900">Live Games</p>
          </div>
      ...
      <footer className="mt-8">
        <div className="max-w-md mx-auto px-4 text-center text-xs text-gray-500">
          <p>
            By signing in to GameSphere, you agree to our Terms of Service and
            Privacy Policy.
          </p>
