                ...
                <div className="flex overflow-x-auto space-x-6 pb-4 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
                  ...
                  <div className="min-w-[240px] bg-white rounded-lg shadow-md p-5 border border-gray-100 hover:shadow-lg transition-all">
                    <div className="flex items-center mb-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-800">Fantasy Basketball</h3>
                  ...
                  <div className="min-w-[240px] bg-white rounded-lg shadow-md p-5 border border-gray-100 hover:shadow-lg transition-all">
                    <div className="flex items-center mb-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-800">Premier Soccer League</h3>
                  ...
                  <div className="min-w-[240px] bg-white rounded-lg shadow-md p-5 border border-gray-100 hover:shadow-lg transition-all">
                    <div className="flex items-center mb-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-800">NFL Fantasy League</h3>
                  ...
                  <div className="min-w-[240px] bg-white rounded-lg shadow-md p-5 border border-gray-100 hover:shadow-lg transition-all">
                    <div className="flex items-center mb-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-800">Cricket World Cup</h3>
                  ...
                  <div className="min-w-[240px] bg-white rounded-lg shadow-md p-5 border border-gray-100 hover:shadow-lg transition-all">
                    <div className="flex items-center mb-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-800">Tennis Grand Slam</h3>
                  ...
                  <div className="min-w-[240px] bg-white rounded-lg shadow-md p-5 border border-gray-100 hover:shadow-lg transition-all">
                    <div className="flex items-center mb-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-800">MLB Home Run Derby</h3>
                  ...
                  <div className="min-w-[240px] bg-white rounded-lg shadow-md p-5 border border-gray-100 hover:shadow-lg transition-all">
                    <div className="flex items-center mb-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-800">Esports Championship</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  <div className="bg-white rounded-lg shadow-md p-5 border border-gray-100 hover:shadow-lg transition-all">
                    <div className="flex items-center mb-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-800">Rugby Union Fans</h3>
                  ...
                  <div className="bg-white rounded-lg shadow-md p-5 border border-gray-100 hover:shadow-lg transition-all">
                    <div className="flex items-center mb-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-800">Volleyball League</h3>
                  ...
                  <div className="bg-white rounded-lg shadow-md p-5 border border-gray-100 hover:shadow-lg transition-all">
                    <div className="flex items-center mb-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-800">Golf Masters Club</h3>
